 ...
 * 
 */
public class SLSensorEntryConverter implements JsonSerializer<SensorEntry>,
		JsonDeserializer<SensorEntry>
{

	@Override
	public SensorEntry deserialize(	JsonElement json,
									Type typeOfT,
									JsonDeserializationContext context) throws JsonParseException
	{
		...
		SensorEntry entry = new SensorEntry(offset,
											name,
											descr,
											valuet,
											valuei,
	...
	@Override
	public JsonElement serialize(SensorEntry src, Type typeOfSrc, JsonSerializationContext context)
	{
